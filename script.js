// --- FIREBASE SETUP ---
    ...
    const i18n = {
        'en': { 
            ...
            givenOn: "Given on", profitCut: "Profit Cut:", intRec: "Interest Received", monthsText: "Months", kishatsText: "Kishats", profitText: "Profit:", missedText: "Missed:", basisText: "BASIS", repTotal: "TOTAL:", caseClosed: "Case Closed ✅"
        },
        'hi': { 
            ...
            setMainTitle: "ऐप सेटिंग्स", setBackup: "डेटा बैकअप", setRestore: "डेटा वापस लाएं", setPinStaff: "स्टाफ PIN बदलें", setPinOwner: "मालिक PIN बदलें 👑", setLogout: "लॉगआउट", setClose: "बंद करें", 
            ...
            givenOn: "तारीख:", profitCut: "प्रॉफिट कट:", intRec: "ब्याज मिला", monthsText: "महीने", kishatsText: "किश्तें", profitText: "प्रॉफिट:", missedText: "छूटा:", basisText: "आधार", repTotal: "कुल जोड़:", caseClosed: "खाता बंद ✅"
        },
        'pa': { 
            ...
            setMainTitle: "ਐਪ ਸੈਟਿੰਗਜ਼", setBackup: "ਡਾਟਾ ਬੈਕਅੱਪ", setRestore: "ਡਾਟਾ ਵਾਪਸ ਲਿਆਓ", setPinStaff: "ਸਟਾਫ ਆਪਣਾ ਪਿੰਨ ਬਦਲੋ", setPinOwner: "ਮਾਲਕ ਆਪਣਾ ਪਿੰਨ ਬਦਲੋ 👑", setLogout: "ਲਾਗਆਉਟ", setClose: "ਬੰਦ ਕਰੋ", 
            ...
            givenOn: "ਤारीख:", profitCut: "ਮੁਨਾਫਾ ਕੱਟਿਆ:", intRec: "ਵਿਆਜ ਮਿਲਿਆ", monthsText: "ਮਹੀਨੇ", kishatsText: "ਕਿਸ਼ਤਾਂ", profitText: "ਮੁਨਾਫਾ:", missedText: "ਛੱਡਿਆ:", basisText: "ਆਧਾਰ", repTotal: "ਕੁੱਲ ਜੋੜ:", caseClosed: "ਖਾਤਾ ਬੰਦ ✅"
        }
    };
            ...
            <div class="cust-card glass-card" style="${(isOwnerMode && c.isPersonal) ? 'border-color: rgba(255, 215, 0, 0.3); background: linear-gradient(145deg, rgba(255, 215, 0, 0.05) 0%, var(--card-bg) 100%);' : ''}">
                ...
                <div id="view-${c.id}" style="display:${openViews[c.id]?'block':'none'}">
                    <div style="display:flex; justify-content:space-between; background:rgba(0,0,0,0.3); padding:15px; border-radius:12px; margin-top:15px;">
                        ...
                        ` : ''}
<div style="text-align:right;"><span style="font-size:10px; color:var(--text-muted);">${t.remainingAcc}</span><br><b style="font-size:14px; color:${c.currentBalance <= 0 ? 'var(--success)' : 'var(--danger)'}">${c.currentBalance <= 0 ? t.caseClosed : '₹' + c.currentBalance.toFixed(0)}</b></div></div>
